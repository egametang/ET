        ...
        object IDictionary.this[object key]
        {
            ...
            set
            {
                ...
                try
                {
                    ...
                    {
                        throw new ArgumentException($"SR.Arg_WrongType {value} {typeof(TValue)} {nameof(value)}");
                    }
                }
                catch (InvalidCastException)
                {
                    throw new ArgumentException($"SR.Arg_WrongType {key} {typeof(TKey)} {nameof(value)}");
                }
            }
        }

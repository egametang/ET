...
同时，ET框架是一个强大灵活的分布式服务端架构，完全可以满足绝大部分大型游戏需求。使用这套框架，客户端开发者就可以自己完成双端开发，节省大量人力物力，节省大量沟通时间。  

**QQ群: 474643097**  
**论坛: <https://et-framework.cn>**  
**课程：请加 QQ:80081771，包教包会，学不会可以打我。**
...
* 熊猫的课程ET框架设计课  
  本课程详细介绍了 ET 框架的设计思路和细节,有需要请加QQ:80081771
  <details> <summary>课程目录</summary>  
...
## ET5 发布！凤姐横空出世！
。。。
## 基于 ET 开发的 MMO 游戏成功上线
<details> <summary>详情</summary>  

 《千古风流》历时两年开发，成功上线。单服 64c128g 机器 3W 在线。证明 ET 具备开发大型游戏的能力，该项目用到的技术：  
1. 动态副本跟分线，按需分配，用完回收  

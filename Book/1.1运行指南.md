...
5. Assets/Resources/GlobalConfig CodeMode选择**Client Server**, 点击Unity菜单 -> ET -> Compile & Reload(或按快捷键**F6**)进行编译
...
2. 点击Unity菜单 -> ET -> Compile & Reload(或按快捷键**F6**)进行编译
...
2. 运行后修改代码，点击Unity菜单 -> ET -> Compile & Reload(或按快捷键**F6**)进行编译并重载即可

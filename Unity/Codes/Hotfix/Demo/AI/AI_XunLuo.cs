...
namespace ET
{
    ...
    {
        public override int Check(AIComponent aiComponent, AIMeta aiConfig)
        {
        ...
        public override async ETTask Execute(AIComponent aiComponent, AIMeta aiConfig, ETCancellationToken cancellationToken)
        {

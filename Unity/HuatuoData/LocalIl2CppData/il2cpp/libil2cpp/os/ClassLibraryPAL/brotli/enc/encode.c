...
#include <os/ClassLibraryPAL/brotli/include/brotli/encode.h>
...
IL2CPP_EXPORT BrotliEncoderState* STDCALL BrotliEncoderCreateInstance(brotli_alloc_func alloc_func,
...
IL2CPP_EXPORT BROTLI_BOOL STDCALL BrotliEncoderIsFinished(BrotliEncoderState* s) {
...
IL2CPP_EXPORT const uint8_t* STDCALL BrotliEncoderTakeOutput(BrotliEncoderState* s, size_t* size) {

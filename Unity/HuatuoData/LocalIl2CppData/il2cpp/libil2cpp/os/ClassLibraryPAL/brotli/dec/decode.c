...
#include <os/ClassLibraryPAL/brotli/include/brotli/decode.h>
...
IL2CPP_EXPORT BROTLI_BOOL STDCALL BrotliDecoderHasMoreOutput(const BrotliDecoderState* s) {
...
IL2CPP_EXPORT const uint8_t* STDCALL BrotliDecoderTakeOutput(BrotliDecoderState* s, size_t* size) {
  uint8_t* result = 0;
...
IL2CPP_EXPORT BROTLI_BOOL STDCALL BrotliDecoderIsUsed(const BrotliDecoderState* s) {
...
IL2CPP_EXPORT BrotliDecoderErrorCode STDCALL BrotliDecoderGetErrorCode(const BrotliDecoderState* s) {
...
IL2CPP_EXPORT uint32_t STDCALL BrotliDecoderVersion() {

...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Model_Session_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(Model.AMessage)};
            ...
            args = new Type[]{typeof(Model.Actor_TestResponse)};
            if (genericMethods.TryGetValue("Call", out lst))
            {
            ...
            args = new Type[]{typeof(Model.Actor_TransferResponse)};
            if (genericMethods.TryGetValue("Call", out lst))
            {
                foreach(var m in lst)
                {
            ...
            args = new Type[]{typeof(Model.G2C_EnterMap)};
            if (genericMethods.TryGetValue("Call", out lst))
            {
                foreach(var m in lst)
                {
            ...
            args = new Type[]{typeof(Model.R2C_Login)};
            if (genericMethods.TryGetValue("Call", out lst))
            {
                foreach(var m in lst)
                {
            ...
            args = new Type[]{typeof(Model.G2C_LoginGate)};
            if (genericMethods.TryGetValue("Call", out lst))
            {
                foreach(var m in lst)
                {
                    ...
                    {
                        method = m.MakeGenericMethod(args);
                        app.RegisterCLRMethodRedirection(method, Call_5);
        ...
        static StackObject* Send_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Model.AMessage message = (Model.AMessage)typeof(Model.AMessage).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Call_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            Model.ARequest request = (Model.ARequest)typeof(Model.ARequest).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            Model.Session instance_of_this_method;
            instance_of_this_method = (Model.Session)typeof(Model.Session).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ...
            var result_of_this_method = instance_of_this_method.Call<Model.Actor_TestResponse>(request);
        ...
        static StackObject* Call_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.Call<Model.Actor_TransferResponse>(request);
        ...
        static StackObject* Call_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.Call<Model.G2C_EnterMap>(request);
        ...
        static StackObject* Call_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.Call<Model.R2C_Login>(request);
        ...
        static StackObject* Call_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            var result_of_this_method = instance_of_this_method.Call<Model.G2C_LoginGate>(request);

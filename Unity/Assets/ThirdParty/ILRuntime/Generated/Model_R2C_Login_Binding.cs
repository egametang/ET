...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Model_R2C_Login_Binding
    {
        ...
        static StackObject* get_Address_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Model.R2C_Login instance_of_this_method;
            instance_of_this_method = (Model.R2C_Login)typeof(Model.R2C_Login).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));

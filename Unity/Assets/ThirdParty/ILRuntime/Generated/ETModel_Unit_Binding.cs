...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_Unit_Binding
    {
        ...
        static StackObject* set_Position_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.Unit instance_of_this_method;
            instance_of_this_method = (ETModel.Unit)typeof(ETModel.Unit).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

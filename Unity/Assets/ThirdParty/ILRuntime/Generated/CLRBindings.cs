...
namespace ILRuntime.Runtime.Generated
{
    class CLRBindings
    {
        ...
        public static void Initialize(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            System_Threading_Tasks_Task_1_R2C_Login_Binding.Register(app);
            System_Runtime_CompilerServices_TaskAwaiter_1_R2C_Login_Binding.Register(app);
            Model_R2C_Login_Binding.Register(app);
            Model_C2G_LoginGate_Binding.Register(app);
            System_Threading_Tasks_Task_1_G2C_LoginGate_Binding.Register(app);
            System_Runtime_CompilerServices_TaskAwaiter_1_G2C_LoginGate_Binding.Register(app);

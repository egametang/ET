...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Threading_Tasks_Task_1_PacketInfo_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(System.Threading.Tasks.Task<Model.PacketInfo>);
            args = new Type[]{};
        ...
        static StackObject* GetAwaiter_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Threading.Tasks.Task<Model.PacketInfo> instance_of_this_method;
            instance_of_this_method = (System.Threading.Tasks.Task<Model.PacketInfo>)typeof(System.Threading.Tasks.Task<Model.PacketInfo>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));

...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Model_Hotfix_Binding
    {
        ...
        static StackObject* GetHotfixTypes_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Model.Hotfix instance_of_this_method;
            instance_of_this_method = (Model.Hotfix)typeof(Model.Hotfix).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));

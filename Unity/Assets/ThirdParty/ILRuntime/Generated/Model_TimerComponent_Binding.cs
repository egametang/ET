...
{
    unsafe class Model_TimerComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Model.TimerComponent);
        ...
        static StackObject* WaitAsync_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Model.TimerComponent instance_of_this_method;
            instance_of_this_method = (Model.TimerComponent)typeof(Model.TimerComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));

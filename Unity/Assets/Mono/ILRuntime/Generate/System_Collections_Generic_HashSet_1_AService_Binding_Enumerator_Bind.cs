...
{
    unsafe class System_Collections_Generic_HashSet_1_AService_Binding_Enumerator_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.HashSet<ET.AService>.Enumerator);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new System.Collections.Generic.HashSet<ET.AService>.Enumerator());
        ...
        static StackObject* get_Current_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            System.Collections.Generic.HashSet<ET.AService>.Enumerator instance_of_this_method = (System.Collections.Generic.HashSet<ET.AService>.Enumerator)typeof(System.Collections.Generic.HashSet<ET.AService>.Enumerator).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));

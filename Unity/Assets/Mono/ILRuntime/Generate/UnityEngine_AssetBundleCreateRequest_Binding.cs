...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_AssetBundleCreateRequest_Binding
    {
        ...
        static StackObject* get_assetBundle_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.AssetBundleCreateRequest instance_of_this_method = (UnityEngine.AssetBundleCreateRequest)typeof(UnityEngine.AssetBundleCreateRequest).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));

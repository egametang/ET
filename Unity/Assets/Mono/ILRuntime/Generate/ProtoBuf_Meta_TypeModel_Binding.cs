...
{
    unsafe class ProtoBuf_Meta_TypeModel_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ProtoBuf.Meta.TypeModel);
            args = new Type[]{typeof(System.IO.Stream), typeof(System.Object), typeof(System.Type)};
        ...
        static StackObject* Deserialize_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ProtoBuf.Meta.TypeModel instance_of_this_method = (ProtoBuf.Meta.TypeModel)typeof(ProtoBuf.Meta.TypeModel).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            var result_of_this_method = instance_of_this_method.Deserialize(@source, @value, @type);

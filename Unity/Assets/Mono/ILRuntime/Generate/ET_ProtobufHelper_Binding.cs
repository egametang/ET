...
{
    unsafe class ET_ProtobufHelper_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ET.ProtobufHelper);
            ...
            args = new Type[]{typeof(System.Type), typeof(System.IO.MemoryStream)};
            method = type.GetMethod("FromStream", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, FromStream_2);
            args = new Type[]{typeof(System.Object), typeof(System.IO.MemoryStream)};
            method = type.GetMethod("ToStream", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ToStream_3);
            args = new Type[]{};
        ...
        static StackObject* ToBytes_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ET.ProtobufHelper.ToBytes(@message);
        ...
        static StackObject* FromBytes_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ET.ProtobufHelper.FromBytes(@type, @bytes, @index, @count);
        ...
        static StackObject* FromStream_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            var result_of_this_method = ET.ProtobufHelper.FromStream(@type, @stream);
        ...
        static StackObject* ToStream_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            ET.ProtobufHelper.ToStream(@message, @stream);

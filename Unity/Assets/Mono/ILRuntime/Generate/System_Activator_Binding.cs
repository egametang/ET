    ...
    unsafe class System_Activator_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            if (genericMethods.TryGetValue("CreateInstance", out lst))
            {
                ...
                {
                    if(m.MatchGenericParameters(args, typeof(System.Collections.Generic.HashSet<ET.ISupportInitializeAdapter.Adapter>)))
                    {
            ...
            if (genericMethods.TryGetValue("CreateInstance", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(System.Collections.Generic.Dictionary<System.Type, ET.ISupportInitializeAdapter.Adapter>)))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            if (genericMethods.TryGetValue("CreateInstance", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(System.Collections.Generic.Dictionary<System.Int64, ET.ISupportInitializeAdapter.Adapter>)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* CreateInstance_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = System.Activator.CreateInstance<System.Collections.Generic.HashSet<ET.ISupportInitializeAdapter.Adapter>>();
        ...
        static StackObject* CreateInstance_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = System.Activator.CreateInstance<System.Collections.Generic.Dictionary<System.Type, ET.ISupportInitializeAdapter.Adapter>>();
        ...
        static StackObject* CreateInstance_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = System.Activator.CreateInstance<System.Collections.Generic.Dictionary<System.Int64, ET.ISupportInitializeAdapter.Adapter>>();

...
namespace ET.Client
{
    public partial class YIUIPanelComponent
    {
        ...
        internal async ETTask<bool> Open()
        {
        ...
        internal async ETTask<bool> Open(ParamVo param)
        {
        ...
        internal async ETTask<bool> Open<P1>(P1 p1)
        {
            UIBase.SetActive(true);
        ...
        internal async ETTask<bool> Open<P1, P2>(P1 p1, P2 p2)
        {
            UIBase.SetActive(true);
        ...
        internal async ETTask<bool> Open<P1, P2, P3>(P1 p1, P2 p2, P3 p3)
        {
            UIBase.SetActive(true);
        ...
        internal async ETTask<bool> Open<P1, P2, P3, P4>(P1 p1, P2 p2, P3 p3, P4 p4)
        {
            UIBase.SetActive(true);
        ...
        internal async ETTask<bool> Open<P1, P2, P3, P4, P5>(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5)
        {
            UIBase.SetActive(true);

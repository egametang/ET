...
namespace YIUIFramework
{
    public class UITaskEventP5<P1, P2, P3, P4, P5>: UIEventBase, IUITaskEventInvoke<P1, P2, P3, P4, P5>
    {
        ...
        {
            return
                    $"UITaskEventP5<{GetParamTypeString(0)},{GetParamTypeString(1)},{GetParamTypeString(2)},{GetParamTypeString(3)},{GetParamTypeString(4)}>";
        }

        public override string GetEventHandleType()
        {
            return
                    $"UITaskEventHandleP5<{GetParamTypeString(0)},{GetParamTypeString(1)},{GetParamTypeString(2)},{GetParamTypeString(3)},{GetParamTypeString(4)}>";
        }
        #endif
    }
}